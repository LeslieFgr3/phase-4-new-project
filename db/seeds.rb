...
f1 = Feeling.create(feeling: "good", content: "testing paragraph", writer: "mr. hansome", user_id: u1.id)
f2 = Feeling.create(feeling: "awesome", content: "testing block", writer: "mrs. yes", user_id: u2.id)